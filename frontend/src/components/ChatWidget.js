    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {!isOpen && (
        <button
          ...
          className="bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all transform hover:scale-110"
        >
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="bg-white rounded-2xl shadow-2xl w-96 h-[600px] flex flex-col overflow-hidden animate-in slide-in-from-bottom-5">
          {/* Header */}
          ...
          <div className="p-4 bg-white border-t border-gray-200">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:border-blue-600"
                disabled={loading}
              />
              <button
                onClick={sendMessage}
